(function(root, factory){root.livestyle = factory();}(this, function () {
/**
...
define('tree',['lodash', 'cssParser', 'range'], function(_, cssParser, range) {
	...
	CSSNode.prototype = {
		...
		insert: function(subtree, pos) {
			...
			if (!this.parent && pos === 0)  {
				...
				// of tokens list
				targetToken = this._hints.endToken + (this.parent ? 0 : 1);
	...
	function skipFormatting(iter) {
		var t, ft = fTokens, shifted = false;
 ...
 */
define('backend/sublimetext',['diff', 'patch'], function(diff, patch) {
	function json(data) {
...
});return require('backend/sublimetext');}));